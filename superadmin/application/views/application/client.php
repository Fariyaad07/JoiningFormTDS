			...
			<div class="col-10">
				...
				<div class="col-12 bg-light">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="card p-3">
								<h5 class="bg-dark text-white p-2">Client Name</h5>
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td><?= $c->client_name ?></td>
											<td>
												<a href="<?= site_url('index.php/client/delete/'.$c->client_id) ?>"
						...
						<div class="col-md-6">
							<div class="card p-3">
								<h5 class="bg-dark text-white p-2">Add New Client Name</h5>
								
								<form method="post" action="<?= site_url('index.php/client/save') ?>">
									<label>Add New Client's Here!</label>
									
									<div class="d-flex">
										<input type="text" name="client_name" class="form-control me-2" required>
